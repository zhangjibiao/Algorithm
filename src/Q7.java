...
public class Q7 {
    ...
    public static int lastSmaller(int[] sortedArr, int luckOne){
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < testTimes; i++) {
            ...
            if(comparator(arr,luckOne) != lastSmaller(arr,luckOne)){
                successd = false;
                System.out.println("luckOne:"+luckOne);
                System.out.println("comparator:"+comparator(arr,luckOne));
                System.out.println("firstBigger:"+lastSmaller(arr,luckOne));
                printArr(arr);
                break;
            }
